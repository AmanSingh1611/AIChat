...
public struct RootDelegate {
    ...
    public init(
        onApplicationDidAppear: (() -> Void)?,
        onApplicationWillEnterForeground: ((Notification) -> Void)?,
        onApplicationDidBecomeActive: ((Notification) -> Void)?,
        onApplicationWillResignActive: ((Notification) -> Void)?,
        onApplicationDidEnterBackground: ((Notification) -> Void)?,
        onApplicationWillTerminate: ((Notification) -> Void)?
    ) {
